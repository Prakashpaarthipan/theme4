var myApp = angular.module("myApp", []);
	myApp.controller("MyController", function MyController($scope){ 
		$scope.sample = [
		{'url' : '2016-17_2971_1_1_101_fr_1.jpg','BRNCODE' : '888','ENTYEAR' : '2016-17','ENTNUMB' : '2971','ENTSRNO' : '1','DESSRNO' : '1','SELSRNO' : '','PRDCODE' : '75012','DESNUMB' : '101','PRDRATN' : '','PURRATE' : '2225','PURSALR' : '3495','tcsdesnumb' : '1006','SALDISC' : '0','VRTNAME' : 'R S PRINT','CATLOG' : '','PLANING' : '','prdcode' : '75012','id' : '1','idv' : '0','ival' : '1',},
		]
