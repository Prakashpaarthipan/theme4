var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="css/theme-default.css" onclick="setCookie(\'assign_theme\', \'css/theme-default.css\', 365);"><img src="img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="css/theme-brown.css" onclick="setCookie(\'assign_theme\', \'css/theme-brown.css\', 365);"><img src="img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="css/theme-blue.css" onclick="setCookie(\'assign_theme\', \'css/theme-blue.css\', 365);"><img src="img/themes/blue.jpg"/></a>'
            +'<a href="#" data-theme="css/theme-black.css" onclick="setCookie(\'assign_theme\', \'css/theme-black.css\', 365);"><img src="img/themes/black.jpg"/></a>'
        +'</div>'
