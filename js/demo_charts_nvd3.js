var nvd3Charts = function() {
        ...
        var myColors = ["#7c50e1","#8DCA35","#00BFDD","#F63357","#F05641",
                        "#f523fb","#fbb623","#ff80f1","#FFFF99","#F7EC37","#F46D43",
	...
	var startChart1 = function() {
		...
		function sinAndCos() {
			...
			return [{
				...
				key : 'S-TEAM' //key  - the name of the series.
			}, {
				values : cos,
				key : 'MANAGEMENT'
			}, {
	...
	var startChart9 = function() {
		...
		nv.addGraph(function() {
			...
			d3.select("#chart-10 svg").datum(exampleData1()).transition().duration(350).call(chart);
