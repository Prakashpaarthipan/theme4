...
(function($) {
            ...
            var s = $(r),
                ...
                f = {
                        ...
                        create: function(i) {
                            var file = f.files[i],
                                ...
                                opts = {
                                    ...
                                    type: type,
                                    extension: ext,
                                    icon: f._assets.getIcon(ext, type, name),
                        ...
                        _box: function(params) {
                            ...
                            if (l.length < 1) {
                                ...
                                appendTo.find('.jFiler-items')
                                    .remove();
                                l = $('<div class="jFiler-items jFiler-row" id="img_row"></div>');
                                s.prop("jFiler").listEl = l;
                    ...
                    _assets: {
                        ...
                        getIcon: function(ext, type, name) {
                            //alert("*****"+ext+"******"+type+"*****"+name+"*****"+name+"*****");
    ...
    $.fn.filer.defaults = {
        ...
        templates: {
            ...
            item: '<li class="jFiler-item"><div class="jFiler-item-container"><div class="jFiler-item-inner"><div class="jFiler-item-info pull-left"><div class="jFiler-item-title" title="{{fi-name}}">{{fi-name | limitTo:30}}</div><div class="jFiler-item-others"><span>size: {{fi-size2}}</span><span>type: {{fi-extension}}</span><span class="jFiler-item-status">{{fi-progressBar}}</span></div><div class="jFiler-item-assets"><ul class="list-inline"><li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li></ul></div></div></div></div></li>',
